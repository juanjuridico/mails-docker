...
# VPN es opcional y queda desactivada por defecto. El navegador autónomo
# usa salida directa para evitar inconsistencias de IP en desafíos legítimos.
PROXY_URL=""
...
if [ -n "$PROXY_URL" ]; then
  ...
  echo "[vpn] desactivada; salida directa"
fi
